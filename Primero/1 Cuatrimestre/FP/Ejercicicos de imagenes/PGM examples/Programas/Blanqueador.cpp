/*
Programa que blanquea de imagenes.
*/
...
void Blanquear(int M, color pixel[][MAX_COLUMNAS], color salida[][MAX_COLUMNAS], int filas, int columnas);
...
int main(){
	...
	Blanquear(M, pixel, salida, filas, columnas);
