/*
Programa que hace el negativo de imagenes.
*/
...
void Invertir(int M, color pixel[][MAX_COLUMNAS], color salida[][MAX_COLUMNAS], int filas, int columnas);
...
int main(){
	...
	Invertir(M, pixel, salida, filas, columnas);
