...
void funcion_filosofos(int id)
{
   ...
   {
      /**
       * Si hacemos que todos cojan hacia un mismo lado (pj todos hacia la derecha)
       * podríamos llegar a una situación de interbloqueo. Con hacer que uno tome el tenedor
       * con una orientación distinta, arreglamos esta situación
       */
      if (id == 0)
      {
