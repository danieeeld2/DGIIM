...
class ProdCons2SU : public HoareMonitor
{
 ...
 int                        // variables permanentes
   ...
   multiplo_impresora,      // variable auxiliar para última impresión de impresora
   multiploscinco;          // contabiliza el número de múltiplos de 5 insertados
 ...
 public:                    // constructor y métodos públicos
   ...
   bool metodo_impresora();           // método que ejecuta la impresora
} ;
// -----------------------------------------------------------------------------
...
{
    if(multiploscinco==num_items/5)
        return false;
    if(multiploscinco-multiplo_impresora == 0)
        impresora.wait();
    assert(multiploscinco-multiplo_impresora>0);
    cout << "Impresora: " << multiploscinco - multiplo_impresora << " nuevos múltiplos de 5" << endl;
    multiplo_impresora = multiploscinco;
    return true;
}
